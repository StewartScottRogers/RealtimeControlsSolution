...
namespace WindowsFormsControlLibrary {
    [Designer(typeof(RadialDialControl.CustomControlDesigner))]
    [ToolboxBitmapMisc]
    [DefaultEvent("DialValueChanged")]
    public partial class RadialDialControl : UserControl {
        #region Public Events
        public event ControlValueChangedEventHandler DialValueChanged;
        #endregion
        ...
        public String Caption {
            get { return customControlRadialDial1.Caption1Text; }
            set { customControlRadialDial1.Caption1Text = value; }
        }
        ...
        public Single DialValue {
            get { return customControlRadialDial1.DialValue; }
            set { customControlRadialDial1.DialValue = value; }
        }
        ...
        public Single DialMinimumValue {
            get {
                return customControlRadialDial1.DialMinimumValue;
            }
            set {
                if (customControlRadialDial1.DialMinimumValue != value) {
                    customControlRadialDial1.DialMinimumValue = value;
                    Refresh();
                }
            }
        }
        ...
        public Single DialMaximumValue {
            get {
                return customControlRadialDial1.DialMaximumValue;
            }
            set {
                if (customControlRadialDial1.DialMaximumValue != value) {
                    customControlRadialDial1.DialMaximumValue = value;
                    Refresh();
                }
            }
        }
        ...
        private void customControlRadialDial1_OnValueChanged(object Sender, DialValueChangedEventArgs DialValueChangedEventArgs) {
            timerEvent.Start();
        }
        private void timerEvent_Tick(object sender, EventArgs e) {
            DialValueChanged.RaiseEvent(customControlRadialDial1.DialValue);
            timerEvent.Stop();
        }
        #endregion
