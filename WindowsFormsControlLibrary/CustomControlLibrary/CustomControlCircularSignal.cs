...
namespace WindowsFormsControlLibrary {
    internal partial class CustomControlCircularSignal : Control {
        #region Members
        private CircularSignalDef TheCircularSignal = new CircularSignalDef(false);

        private CaptionDef[] TheCaptions = new CaptionDef[]{
            new CaptionDef(new Point(4, 3), "Circular Signal", Color.Black, true),
        ...
        #region Constructors
        public CustomControlCircularSignal() {
            InitializeComponent();
            this.SetStyle(
        ...
        #region Circular Signal
        [System.ComponentModel.Browsable(true),
        System.ComponentModel.Category("Circular Signal"),
        System.ComponentModel.Description("The Signaled value.")]
        public Boolean Signaled {
            get {
                return TheCircularSignal.Signaled;
            }
            set {
                if (TheCircularSignal.Signaled != value) {
                    TheCircularSignal.Signaled = value;
                    if (this.DesignMode)
                        IsBackgroundDrawing = true;
                    Refresh();
                }
        ...
        protected override void OnPaint(PaintEventArgs PaintEventArgs) {
            ...
            using (var graphics = Graphics.FromImage(bitmap)) {
                ...
                if (TheCircularSignal.Signaled) {
                    graphics.RenderCircularSignal(rectangle, BackColor, depthRaised);
                } else {
                    graphics.RenderCircularSignal(rectangle, BackColor, depthRaised);
                }
