...
namespace WindowsFormsControlLibrary {
    [Designer(typeof(PushButtonControl.CustomControlDesigner))]
    [ToolboxBitmapMisc]
    [DefaultEvent("Click")]
    public partial class PushButtonControl : UserControl {
        #region Public Events
        public event PushButtonClickedEventHandler OnClicked;
        public delegate void PushButtonClickedEventHandler(object Sender);
        private void RaisePushButtonClickedEvent() { if (OnClicked == null) return; OnClicked(this); }
        #endregion
        ...
        System.ComponentModel.Category("Push Button"),
        System.ComponentModel.Description("The caption.")]
        public String Caption {
            get { return customControlPushButton1.Caption1Text; }
            set { customControlPushButton1.Caption1Text = value; }
        }
        #endregion

        #region Private Event Handlers
        private void customControlPushButton1_OnClicked(object Sender, PushButtonClickedEventArgs PushButtonClickedEventArgs) {
